...
pub enum WindowsDeploymentAuditEventKind {
    ...
    ShadowEvaluationStarted,
    ShadowProfileVerified,
    ShadowCohortVerified,
    ShadowParticipationVerified,
    ShadowEnrollmentVerified,
    ShadowObservationCollected,
    ShadowProposalCreated,
    ShadowProposalCommitted,
    ShadowHumanReferenceRecorded,
    ShadowProposalRevealed,
    ShadowComparisonCreated,
    ShadowAdjudicationCreated,
    ShadowMetricCalculated,
    ShadowReadinessAssessed,
    ShadowReportCreated,
    ShadowInternalPublicationRecorded,
    ShadowDivergenceQuarantined,
    ShadowReplayVerified,
    ShadowTamperRejected,
    ShadowStoreRecovered,
    ShadowStoreCleaned,
}
